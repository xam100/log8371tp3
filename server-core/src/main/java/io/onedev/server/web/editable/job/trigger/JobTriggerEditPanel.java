...
abstract class JobTriggerEditPanel extends Panel implements JobAware {

	private final List<JobTrigger> triggers;
	
	private final int triggerIndex;
	
	public JobTriggerEditPanel(String id, List<JobTrigger> triggers, int triggerIndex) {
		super(id);
	...
	protected void onInitialize() {
		...
		form.add(new AjaxLink<Void>("close") {
			...
			protected void updateAjaxAttributes(AjaxRequestAttributes attributes) {
				...
				attributes.getAjaxCallListeners().add(new ConfirmLeaveListener(JobTriggerEditPanel.this));
			}
